  ...
  if (typeof content === "string") {
    ...
    for (let i = 0; i < content.length; i++) {
      ...
      if (typeof v1 === "string") {
        ...
        const height = doc.heightOfString(`      ${replaced}`, {
          width: doc.page.width - 120,
          lineGap: 4,
        });
...
async function ProReport(
  ...
  let panchangContent = [
    "",
    "",
    "Divyam, born under the Uttara Ashadha Nakshatra, is characterized by a strong sense of determination and ambition. With a natural leadership quality and a confident demeanor, he is driven to achieve his goals and is not easily swayed by obstacles. His disciplined and principled nature guides him on a path of success, often earning respect and admiration from others. Divyam's journey in life is one of growth and accomplishment, marked by perseverance and a strong sense of responsibility towards his endeavors.",
    "Divyam, born under the Variyana Yogam, possesses a strong and determined nature, striving towards exceptional achievements and fulfilling ambitious goals. His Yogam characteristics indicate a deep sense of spiritual growth and a constant drive for self-improvement. With a keen awareness of his own potential, Divyam strives to make a positive impact on those around him, blending determination with compassion in all his endeavors.",
  ];
  ...
  let content2 = {
    physical_attributes:
      "Divyam has a balanced body built with a charming face type. His eyes are expressive and convey warmth. In terms of physical appearance, Divyam exudes an elegant aura that captivates those around him.",
    personality: [
      "Divyam possesses a diplomatic nature, seeking harmony in relationships. He has a creative and artistic flair, expressing himself through various mediums. Divyam's sense of justice and fairness is evident in his interactions with others.",
    ],
    character: [
      "Divyam is known for his sociable nature, easily connecting with people from all walks of life. He showcases a strong sense of teamwork, thriving in collaborative environments. Divyam exhibits a strong sense of balance and poise in challenging situations, handling them with grace.",
    ],
    positive_behavior: [
      "Divyam demonstrates a cooperative attitude, always willing to lend a helping hand to those in need. His adaptability allows him to navigate diverse situations with ease. Divyam's innate sense of diplomacy enables him to mediate conflicts and find amicable solutions.",
    ],
    negative_behavior: [
      "Divyam may exhibit indecisiveness at times, struggling to make firm decisions. He might also experience self-doubt, leading to moments of insecurity. Divyam's tendency towards people-pleasing can sometimes hinder his personal growth and assertiveness.",
    ],
    parenting_tips:
      "To support Divyam in overcoming his indecisiveness and self-doubt, it is essential to encourage him to trust his instincts and make decisions confidently. Provide opportunities for him to practice making choices independently and offer positive reinforcement for his efforts. Teach Divyam to prioritize his needs and opinions, fostering a sense of self-assurance and empowerment. By celebrating his successes and encouraging autonomy, Divyam can develop a strong sense of self-confidence and assertiveness, aiding in his personal growth.",
  };

  let content3 = {
    emotional_state:
      "Divyam has a structured and disciplined emotional state, valuing tradition, responsibility, and hard work. His beliefs are rooted in practicality and ambition, leading him to be goal-oriented and focused on his long-term success. Emotionally, he may struggle with expressing vulnerability but finds comfort in stability and reliability in relationships.",
    emotions: [
      "Determined and persevering in pursuing his goals, feeling secure in well-defined boundaries, and finding satisfaction in achieving long-term objectives.",
    ],
    feelings: [
      "Serious and reserved in expressing emotions, feeling responsible for others' well-being, and valuing respect and honor in relationships.",
    ],
    reactions: [
      "Responding to challenges with perseverance and self-discipline, adapting to changes with cautious planning, and seeking emotional fulfillment in long-lasting relationships.",
    ],
    negative_imbalance: [
      "Tendency to suppress emotions leading to detachment in relationships, fear of vulnerability hindering emotional connection, and rigid adherence to traditions causing emotional stagnation.",
    ],
    parenting_tips:
      "To nurture Divyam's emotional balance and support his growth, encourage open communication about feelings and emotions, provide opportunities for healthy expression of vulnerability, and promote self-awareness through mindfulness practices. Offer guidance on building emotional resilience, fostering adaptability in challenging situations, and encouraging authentic emotional connections with loved ones. Emphasize the importance of flexibility in beliefs and traditions to allow emotional growth and cultivate a supportive environment that values emotional authenticity and sensitivity.",
  };

  let content4 = {
    core_insights:
      "Divyam's core identity is defined by his innovative and independent nature. He is motivated by the desire to bring about change and progress in the world. His inner strength lies in his ability to think outside the box and challenge traditional norms. However, his ego may impact his growth by making him overly rebellious and detached from emotional connections.",
    recognitions: [
      "Achieving recognition for his unique ideas and unconventional approach to solving problems.",
      "Seeking acknowledgment for his humanitarian efforts and interest in social causes.",
      "Striving for recognition for his visionary thinking and ability to envision a better future.",
    ],
    core_identity: [
      "Determined to pave his own path and make a significant impact on society.",
      "Possessing a strong sense of individuality and a rebellious spirit that breaks free from conformity.",
      "Inherently curious and forward-thinking, driving him to explore new ideas and challenge the status quo.",
    ],
    parenting_tips:
      "Encouraging Divyam to channel his rebellious spirit and innovative ideas towards constructive projects can help him grow. Foster his independence by allowing him to pursue his interests and express his creativity. Provide support and guidance to help him navigate challenges while nurturing his uniqueness. Celebrate his achievements and efforts to boost his confidence and motivation.",
  };
